...
public class ItemReaderConfiguration {
    ...
    private FlatFileItemReader<Person> csvFileItemReader() throws Exception {
        ...
        FlatFileItemReader<Person> csvItemFileReader = new FlatFileItemReaderBuilder<Person>()
                .name("csvItemFileReader")
                .encoding("UTF-8")
                .resource(new ClassPathResource("test.csv"))
                .linesToSkip(1)
                .lineMapper(lineMapper)
                .build();
        csvItemFileReader.afterPropertiesSet();
        return csvItemFileReader;
    }
